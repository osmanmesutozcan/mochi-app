 ...
 */
export class RestorablePool<T extends IObservableDisposable = IObservableDisposable>
...
namespace Private {
   ...
   */
  export const injectedProperty = new AttachedProperty<IObservableDisposable, boolean>({
    name: 'injected',
    create: () => false,
  });
   ...
   */
  export const nameProperty = new AttachedProperty<IObservableDisposable, string>({
    name: 'name',
    create: () => '',
  });
}
