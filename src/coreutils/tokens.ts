 ...
 */
export const ISettingRegistry = new Token<ISettingRegistry>('@mochi/coreutils:ISettingRegistry');
...
export namespace ISettingRegistry {
   ...
   */
  export type Primitive = 'array' | 'boolean' | 'null' | 'number' | 'object' | 'string';
  ...
  export interface ISchema extends IProperty {
     ...
     */
    'mochi.app.setting-deprecated'?: boolean;

    /**
     * The JupyterLab icon class hint.
     */
    'mochi.app.setting-icon-class'?: string;

    /**
     * The JupyterLab icon label hint.
     */
    'mochi.app.setting-icon-label'?: string;
 ...
 */
export const IStateDB = new Token<IStateDB>('@mochi/coreutils:IStateDB');
