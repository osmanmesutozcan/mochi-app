...
/**
 * - breadCrumb: The path icons above the database
 ...
 * - listing: The icons to the left of the database listing items
...
const containerCSSSideBar: NestedCSSProperties = {
  ...
  $nest: {
    ...
    '.m-SideBar.m-mod-left .p-TabBar-tab &': {
      transform: 'rotate(90deg)',
    },
    // left sidebar currently selected tab div
    '.m-SideBar.m-mod-left .p-TabBar-tab.p-mod-current &': {
      transform:
        'rotate(90deg)\n' +
        '    translate(\n' +
    ...
    '.m-SideBar.m-mod-right .p-TabBar-tab &': {
      transform: 'rotate(-90deg)',
    },
    // right sidebar currently selected tab div
    '.m-SideBar.m-mod-right .p-TabBar-tab.p-mod-current &': {
      transform:
        'rotate(-90deg)\n' +
        '    translate(\n' +
        '      calc(0.5 * var(--jp-border-width)),\n' +
